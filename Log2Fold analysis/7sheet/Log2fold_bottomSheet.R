...
abund_table<-read.csv("bottomReducedNict.csv",row.names=1,check.names=FALSE)
meta_table<-read.csv("bottom_sheet_meta_Nic.csv",row.names=1,check.names=FALSE)
...
ggplot(sigtabgen3, aes(y=Genus, x=log2FoldChange))+
  ggtitle("Bed Sheet Microbiome: Smoking/Non-smoking") +
...
# 
# title = "BottomSheet: top OTUs; Family taxa; 01-019=smoker; 101-110=non-smoker"
